...
#define BATTERY_SHUTDOWN_TEMPERATURE 68 //Bug493176,zhaosidong.wt,MODIFY,20191017,68 degree trigger shutdown
...
#if defined(CONFIG_BATTERY_CISD)
extern void batt_cisd_init(struct mtk_battery *battery);
extern int batt_cisd_create_attrs(struct device *dev);
#endif
