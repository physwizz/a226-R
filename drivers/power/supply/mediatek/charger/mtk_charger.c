...
#include <linux/fb.h> //Bug516174,zhaosidong.wt,ADD,20191126,charge current limit for AP overheat
...
//-Bug516174,zhaosidong.wt,ADD,20191126,charge current limit
...
static void charger_check_status(struct charger_manager *info)
{
	...
	ap_thermal_machine(info);  //Bug516174,zhaosidong.wt,ADD,20191126,charge current limit for AP overheat
...
static int mtk_charger_probe(struct platform_device *pdev)
{
	...
	info->ap_temp = 0xffff; //Bug516174,zhaosidong.wt,ADD,20191126,charge current limit for AP overheat
