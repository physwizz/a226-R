...
//+bug   , renyiyue.wt, add, 2020.12.11, add emmc flash_name & vendor name, start
...
static ssize_t flash_name_show(struct device *dev, struct device_attribute *attr, char *buf)
{
    ...
    switch (card->cid.manfid) {
        ...
        case 0x13:
            vendor_name = "Micron";
            if (strncmp(card->cid.prod_name, "G1J9R8", strlen("G1J9R8")) == 0)
        ...
        case 0x15:
            ...
            else if (strncmp(card->cid.prod_name, "3V6CAB", strlen("3V6CAB")) == 0)
                emcp_name = "KM3V6001CA_B708";
            else if (strncmp(card->cid.prod_name, "3V6CMB", strlen("3V6CMB")) == 0)
                emcp_name = "KM3V6001CM_B705";
...
//-bug   , renyiyue.wt, add, 2020.12.11, add emmc flash_name & vendor name, end
