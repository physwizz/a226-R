...
#define DEF_INI_NAME_PATH		"/vendor/firmware/mp_ili7807s_txd.ini"
#define DEF_FW_FILP_PATH		"/sdcard/ILITEK_FW"
#define DEF_INI_REQUEST_PATH		"mp_ili7807s_txd.ini"
#define DEF_FW_REQUEST_PATH		"ILITEK_FW"
static unsigned char CTPM_FW_DEF[] = {
	#include "FW_TDDI_TRUNK_FB.ili"
};
static unsigned char CTPM_FW_DEF_EA1[] = {  //for Korea version
	#include "FW_TDDI_TRUNK_FB_EA1.ili"
};
