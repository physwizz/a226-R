...
#include "w1hi846frontst2_mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W1HI846FRONTST2_SENSOR_ID - 1,
...
static struct stCAM_CAL_DATAINFO_STRUCT w1hi846frontst2_eeprom_data ={
	.sensorID= W1HI846FRONTST2_SENSOR_ID,
	.deviceID = 0x02,
	.dataLength = 0x076A,
...
static struct stCAM_CAL_CHECKSUM_STRUCT w1hi846frontst2_checksum[8] =
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				//+bug604664 zhouyikuan, add, 2020/12/14,hi846 eeprom bring up
				size = imgSensorReadEepromData(&w1hi846frontst2_eeprom_data,w1hi846frontst2_checksum);
				if(size != w1hi846frontst2_eeprom_data.dataLength || (w1hi846frontst2_eeprom_data.sensorVendorid >> 24)!= read_n22_hi846_eeprom(0x0001)) {
					pr_err("get eeprom data failed\n");
					if(w1hi846frontst2_eeprom_data.dataBuffer != NULL) {
						kfree(w1hi846frontst2_eeprom_data.dataBuffer);
						w1hi846frontst2_eeprom_data.dataBuffer = NULL;
					}
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
						...
						if(0x01 != w1hi846frontst2_eeprom_data.dataBuffer[0x03]) {
							*sensor_id = 0xFFFFFFFF;
							kfree(w1hi846frontst2_eeprom_data.dataBuffer);
							w1hi846frontst2_eeprom_data.dataBuffer = NULL;
							return ERROR_SENSOR_CONNECT_FAIL;
						}else{
							imgSensorSetEepromData(&w1hi846frontst2_eeprom_data);
							pr_info("Read eeprom success, w1hi846frontst2_eeprom_data lens id: 0x%x\n", w1hi846frontst2_eeprom_data.dataBuffer[0x03]);
						}
				}
						//-bug604664 wangmingli, add, 2021/11/9,hi846 lens differentiation
				//-bug604664 zhouyikuan, add, 2020/12/14,hi846 eeprom bring up
...
UINT32 W1HI846FRONTST2_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
