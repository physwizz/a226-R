...
#include "w1gc5035cwidecxt_mipi_raw.h"
...
#define EEPROM_FM24C64S_ID 0xA0
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = W1GC5035CWIDECXT_SENSOR_ID,
...
static struct stCAM_CAL_DATAINFO_STRUCT n22_gc5035c_wide_cxt_eeprom_data ={
	.sensorID= W1GC5035CWIDECXT_SENSOR_ID,
	.deviceID = 0x10,
	.dataLength = 0x076A,
	.sensorVendorid = 0x16030000,
	.vendorByte = {1,2,3,4},
	.dataBuffer = NULL,
};
static struct stCAM_CAL_CHECKSUM_STRUCT n22_gc5035c_wide_cxt_checksum[8] =
{
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				gc5035_otp_identify();
				//+bug604664 liuxingyu.wt, add, 2020/12/17, hi556  eeprom bring up
				size = imgSensorReadEepromData(&n22_gc5035c_wide_cxt_eeprom_data,n22_gc5035c_wide_cxt_checksum);
				if((size != n22_gc5035c_wide_cxt_eeprom_data.dataLength) || ((n22_gc5035c_wide_cxt_eeprom_data.sensorVendorid >> 24)!= read_eeprom(0x0001))) {
					pr_err("gc5035 get eeprom data failed\n");
					if(n22_gc5035c_wide_cxt_eeprom_data.dataBuffer != NULL) {
						kfree(n22_gc5035c_wide_cxt_eeprom_data.dataBuffer);
						n22_gc5035c_wide_cxt_eeprom_data.dataBuffer = NULL;
					}
					//*sensor_id = 0xFFFFFFFF;
					//return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					pr_info("get eeprom data success\n");
					imgSensorSetEepromData(&n22_gc5035c_wide_cxt_eeprom_data);
				}
				//+bug604664 liuxingyu.wt, add, 2020/12/17, hi556  eeprom bring up
