...
#define PFX "W1OV64B40REARTXD_camera_sensor"
...
#include "w1ov64b40reartxd_mipi_raw.h"
#include "w1ov64b40reartxd_Sensor_setting.h"

#define _I2C_BUF_SIZE 4096
kal_uint16 _ov64_i2c_data [_I2C_BUF_SIZE];
unsigned int _ov64_size_to_write;
bool _ov64_is_seamless;
...
//+bug604664 liudijin, add, 2021/05/07,ov64b40 sensor enable sensor pdc and crosstalk function.
#define W1OV64B40REARTXD_PDC_ENABLE 1
#define W1OV64B40REARTXD_PDC_OTP_DUMP 0
#define W1OV64B40REARTXD_CROSSSTALK_ENABLE 1
#define W1OV64B40REARTXD_CROSSSTALK_OTP_DUMP 0
//-bug604664 liudijin, add, 2021/05/07,ov64b40 sensor enable sensor pdc and crosstalk functions.

//+bug604664 liudijn, add, 2021/03/29, w1ov64b40reartxd eeprom bring up.
#define W1OV64B40REARTXD_OTP_ENABLE 1
#if W1OV64B40REARTXD_OTP_ENABLE
#define EEPROM_BL24SA64D_ID 0xA0
static kal_uint16 w1ov64b40reartxd_read_eeprom(kal_uint32 addr)
{
...
static struct imgsensor_info_struct imgsensor_info = {
     .sensor_id = W1OV64B40REARTXD_SENSOR_ID,
     ...
     .min_gain = 64, /*1x gain*/
     //+bug604664 liudijin, add, 2021/06/25,fixed ov64b40 sensor super night takepicture black issue.
     .max_gain = 4096, /*16x gain*/
     //-bug604664 liudijin, add, 2021/06/25,fixed ov64b40 sensor super night takepicture black issue.
     .min_gain_iso = 100,
     .gain_step = 1,
     .gain_type = 1,/*to be modify,no gain table for sony*/
     .max_frame_length = 0xffffe0,     /* max framelength by sensor register's limitation */
     ...
     .i2c_addr_table = {0x20,0xff}, //bug621970 liudijin, add, 2021/03/16,update 1st ov64b40 sensor  i2c address.
     .i2c_speed = 1000,
};
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
     {9280, 6944, 0,    0,    9280, 6944, 4640, 3472, 8, 2, 4624, 3468, 0, 0, 4624, 3468}, /*Preview*/
     {9280, 6944, 0,    0,    9280, 6944, 4640, 3472, 8, 2, 4624, 3468, 0, 0, 4624, 3468}, /*capture*/
     {9280, 6944, 0,    864,  9280, 5216, 4640, 2608, 8, 4, 4624, 2600, 0, 0, 4624, 2600}, /*normal video*/
     {9280, 6944, 0,  848,  9280, 5248, 2320, 1312,  4, 6, 2312, 1300,  0, 0, 2312, 1300}, /*hs_video*/
     {9280, 6944, 0,    0,    9280, 6944, 2320, 1736, 4, 0, 2312, 1736, 0, 0, 2312, 1736}, /*slim video*/
     {9280, 6944, 0,    0,    9280, 6944, 4640, 3472, 8, 2, 4624, 3468, 0, 0, 4624, 3468}, /*custom1*/
     {9280, 6944, 0,    864,  9280, 5216, 4640, 2608, 8, 4, 4624, 2600, 0, 0, 4624, 2600}, /*custom2*/
     {9280, 6944,  0,   0,    9280, 6944, 9280, 6944,12, 4, 9248, 6936, 0, 0, 9248, 6936}, /*custom3*/
     {9280, 6944, 2048, 2016, 5184, 2912, 1296, 728,  8, 4, 1280, 720,  0, 0, 1280, 720}, /*custom4*/
...
static void set_dummy(void)
{
    if(!_ov64_is_seamless) {
        ...
        _ov64_i2c_data[_ov64_size_to_write++] = 0x3840;
        _ov64_i2c_data[_ov64_size_to_write++] = imgsensor.frame_length >> 16;
        _ov64_i2c_data[_ov64_size_to_write++] = 0x380e;
        _ov64_i2c_data[_ov64_size_to_write++] = imgsensor.frame_length >> 8;
        _ov64_i2c_data[_ov64_size_to_write++] = 0x380f;
        _ov64_i2c_data[_ov64_size_to_write++] = imgsensor.frame_length & 0xFF;
    }
...
static void write_shutter(kal_uint32 shutter)
{
    ...
    if(!_ov64_is_seamless) {
        ...
        _ov64_i2c_data[_ov64_size_to_write++] = 0x380f;
        _ov64_i2c_data[_ov64_size_to_write++] = imgsensor.frame_length & 0xFF;
        _ov64_i2c_data[_ov64_size_to_write++] = 0x3500;
        _ov64_i2c_data[_ov64_size_to_write++] = (shutter >> 16) & 0xFF;
        _ov64_i2c_data[_ov64_size_to_write++] = 0x3501;
        _ov64_i2c_data[_ov64_size_to_write++] = (shutter >> 8) & 0xFF;
        _ov64_i2c_data[_ov64_size_to_write++] = 0x3502;
        _ov64_i2c_data[_ov64_size_to_write++] = (shutter)  & 0xFF;
    }
    pr_debug("shutter =%d, framelength =%d, realtime_fps =%d _ov64_is_seamless %d\n",
            shutter, imgsensor.frame_length, realtime_fps, _ov64_is_seamless);
}
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
     ...
     //+bug604664 liudijin, add, 2021/06/25,fixed ov64b40 sensor super night takepicture black issue.
     if(iReg > 0x4000)    //sensor 15.5xGain
     {
          iReg = 0x4000;
     }
     //-bug604664 liudijin, add, 2021/06/25,fixed ov64b40 sensor super night takepicture black issue.
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    unsigned long flags;
    //+bug604664 liudijin, add, 2021/06/25,fixed ov64b40 sensor super night takepicture black issue.
    kal_uint16  value03508 = 0;
    kal_uint16  value03509 = 0;
    kal_uint16  value0350A = 0;
    kal_uint16  value0350B = 0;
    kal_uint16  value0350C = 0;
    //-bug604664 liudijin, add, 2021/06/25,fixed ov64b40 sensor super night takepicture black issue.
    ...
    if (!_ov64_is_seamless) {
        if (reg_gain > 0xff0) {
            ...
            write_cmos_sensor(0x03509, 0xf0);
            reg_gain = reg_gain*1024/0xff0; //calculate 15xAgain+ £¿Dgain
        ...
        if (reg_gain > 0xff0) {
            _ov64_i2c_data[_ov64_size_to_write++] = 0x03508;
            _ov64_i2c_data[_ov64_size_to_write++] =  reg_gain >> 0xF;
            _ov64_i2c_data[_ov64_size_to_write++] = 0x03509;
            _ov64_i2c_data[_ov64_size_to_write++] =  reg_gain & 0xf0;
            reg_gain = reg_gain*1024/0xff0; //calculate 15xAgain+ £¿Dgain
            _ov64_i2c_data[_ov64_size_to_write++] = 0x0350A;
            _ov64_i2c_data[_ov64_size_to_write++] =  (reg_gain >>10)&0xF;
            _ov64_i2c_data[_ov64_size_to_write++] = 0x0350B;
            _ov64_i2c_data[_ov64_size_to_write++] =  (reg_gain >> 2) & 0xFF;
            _ov64_i2c_data[_ov64_size_to_write++] = 0x0350C;
            _ov64_i2c_data[_ov64_size_to_write++] =  (reg_gain & 0x3) << 6;
        } else {
            //xD gain with Again
            _ov64_i2c_data[_ov64_size_to_write++] = 0x03508;
            _ov64_i2c_data[_ov64_size_to_write++] =  reg_gain >> 8;
            _ov64_i2c_data[_ov64_size_to_write++] = 0x03509;
            _ov64_i2c_data[_ov64_size_to_write++] =  reg_gain & 0xff;
            _ov64_i2c_data[_ov64_size_to_write++] = 0x0350A;
            _ov64_i2c_data[_ov64_size_to_write++] = 0x01;
            _ov64_i2c_data[_ov64_size_to_write++] = 0x0350B;
            _ov64_i2c_data[_ov64_size_to_write++] =0x00;
            _ov64_i2c_data[_ov64_size_to_write++] = 0x0350C;
            _ov64_i2c_data[_ov64_size_to_write++] = 0x00;
    ...
    value03508 = read_cmos_sensor(0x03508);
    value03509 = read_cmos_sensor(0x03509);
    value0350A = read_cmos_sensor(0x0350A);
    value0350B = read_cmos_sensor(0x0350B);
    value0350C = read_cmos_sensor(0x0350C);
    //LOG_INF( "[dennis] read_cmos_sensor   value03508:0x%x value03509:0x%x value0350A:0x%x value0350B:0x%x value0350C:0x%x gain:%d",
    //value03508, value03509, value0350A, value0350B, value0350C, gain);
    //-bug604664 liudijin, add, 2021/06/25,fixed ov64b40 sensor super night takepicture black issue.
...
{
    //LOG_INF("000 w1ov64b shutter =%d, target_frame_length =%d\n", shutter, target_frame_length);
    spin_lock(&imgsensor_drv_lock);
    ...
    spin_unlock(&imgsensor_drv_lock);
    set_shutter(shutter);
    //LOG_INF("Exit! w1ov64b shutter =%d, framelength =%d  imgsensor.dummy_line =%d\n", shutter,imgsensor.frame_length,imgsensor.dummy_line );
}
...
static void preview_setting(void)
{
    ...
    ov64b2q_table_write_cmos_sensor(
        ...
        pr_debug("%s _ov64_is_seamless %d, _ov64_size_to_write %d\n",
            __func__, _ov64_is_seamless, _ov64_size_to_write);

        if (_ov64_size_to_write + _length > _I2C_BUF_SIZE) {
            pr_err("_too much i2c data for fast siwtch %d\n",
                _ov64_size_to_write + _length);
            return;
        }
        memcpy((void *) (_ov64_i2c_data + _ov64_size_to_write),
            addr_data_pair_preview_ov64b2q,
...
static void custom1_setting(void)
{
    ...
    _length = sizeof(ov64_addr_data_pair_custom1) / sizeof(kal_uint16);
    if(!_ov64_is_seamless) {
        ov64b2q_table_write_cmos_sensor(
        ov64_addr_data_pair_custom1,
        _length);
    } else {
        pr_debug("%s _ov64_is_seamless %d, _ov64_size_to_write %d\n",
            __func__, _ov64_is_seamless, _ov64_size_to_write);
        ...
        memcpy((void *) (_ov64_i2c_data + _ov64_size_to_write),
            ov64_addr_data_pair_custom1,
            sizeof(ov64_addr_data_pair_custom1));
        _ov64_size_to_write += _length;
    }
...
static void custom2_setting(void)
{
    ...
    _length = sizeof(ov64_addr_data_pair_custom2) / sizeof(kal_uint16);
    if(!_ov64_is_seamless) {
        ov64b2q_table_write_cmos_sensor(
        ov64_addr_data_pair_custom2,
        _length);
    } else {
        pr_debug("%s _ov64_is_seamless %d, _ov64_size_to_write %d\n",
            __func__, _ov64_is_seamless, _ov64_size_to_write);
        ...
        memcpy((void *) (_ov64_i2c_data + _ov64_size_to_write),
            ov64_addr_data_pair_custom2,
            sizeof(ov64_addr_data_pair_custom2));
        _ov64_size_to_write += _length;
    }
...
static void custom3_setting(void)
{
    ...
    pr_debug("E\n");
    ov64b2q_burst_write_cmos_sensor(ov64_addr_data_pair_custom3,
        sizeof(ov64_addr_data_pair_custom3)/sizeof(kal_uint16));

    _length = sizeof(ov64_addr_data_pair_custom3) / sizeof(kal_uint16);
    if(!_ov64_is_seamless) {
        ov64b2q_table_write_cmos_sensor(
        ov64_addr_data_pair_custom3,
        _length);
    } else {
        pr_debug("%s _ov64_is_seamless %d, _ov64_size_to_write %d\n",
            __func__, _ov64_is_seamless, _ov64_size_to_write);
        ...
        memcpy((void *) (_ov64_i2c_data + _ov64_size_to_write),
            ov64_addr_data_pair_custom3,
            sizeof(ov64_addr_data_pair_custom3));
        _ov64_size_to_write += _length;
    }
}    /*    custom3_setting  */
...
static void custom4_setting(void)
{
    ...
    _length = sizeof(ov64_addr_data_pair_custom4) / sizeof(kal_uint16);
    if(!_ov64_is_seamless) {
        ov64b2q_table_write_cmos_sensor(
        ov64_addr_data_pair_custom4,
        _length);
    } else {
        pr_debug("%s _ov64_is_seamless %d, _ov64_size_to_write %d\n",
            __func__, _ov64_is_seamless, _ov64_size_to_write);
        ...
        memcpy((void *) (_ov64_i2c_data + _ov64_size_to_write),
            ov64_addr_data_pair_custom4,
            sizeof(ov64_addr_data_pair_custom4));
        _ov64_size_to_write += _length;
    }
...
static void custom5_setting(void)
{
    ...
    pr_debug("E\n");
    _length = sizeof(ov64_addr_data_pair_custom5) / sizeof(kal_uint16);
    if(!_ov64_is_seamless) {
        ov64b2q_table_write_cmos_sensor(
        ov64_addr_data_pair_custom5,
        _length);
    } else {
        pr_debug("%s _ov64_is_seamless %d, _ov64_size_to_write %d\n",
            __func__, _ov64_is_seamless, _ov64_size_to_write);
        ...
        memcpy((void *) (_ov64_i2c_data + _ov64_size_to_write),
            ov64_addr_data_pair_custom5,
            sizeof(ov64_addr_data_pair_custom5));
        _ov64_size_to_write += _length;
    }
...
#ifdef W1OV64B40REARTXD_PDC_ENABLE
static kal_uint16 w1ov64b40reartxd_PDC_setting_burst[720*2];

static void w1ov64b40reartxd_read_sensor_pdc_Cali(void)
{
	//kal_uint16 idx = 0, eeprom_PDC_addr = 0x1143, sensor_PDC_addr1 = 0x5C0E, sensor_PDC_addr2 = 0x5900;
	kal_uint16 idx = 0, eeprom_PDC_addr = 0x0D5E, sensor_PDC_addr2 = 0x5F80;
	#if W1OV64B40REARTXD_PDC_OTP_DUMP
        kal_uint16 idx3 = 0;
	#endif

	for (idx = 12; idx < 732; idx++) {
		eeprom_PDC_addr = 0x0D5E + idx;
		sensor_PDC_addr2 = 0x5F80 + idx - 12;
		w1ov64b40reartxd_PDC_setting_burst[2*(idx-12)] = sensor_PDC_addr2;
		w1ov64b40reartxd_PDC_setting_burst[2*(idx-12) + 1] = read_cmos_eeprom_8(eeprom_PDC_addr);
                #if W1OV64B40REARTXD_PDC_OTP_DUMP
                idx3 = 2*(idx-12) + 1;
                LOG_INF( "dump: sensor_PDC_addr2[%d]=0x%x, PDC_addr2_data[%d]=0x%x \n",
                    idx, sensor_PDC_addr2,idx3, w1ov64b40reartxd_PDC_setting_burst[2*(idx-12) + 1]);
                #endif

	}
}

static void w1ov64b40reartxd_write_sensor_PDC(void)
{
	#if W1OV64B40REARTXD_PDC_OTP_DUMP
	kal_uint16  value5000 = 0;
	kal_uint16 value5F80 = 0;
	kal_uint16 value5F81 = 0;
	kal_uint16 value5F82 = 0;
        kal_uint16 value624F = 0;
	#endif
	//write_cmos_sensor(0x5000,0xcf); //enable sensor pdc 0x624f
	ov64b2q_burst_write_cmos_sensor(w1ov64b40reartxd_PDC_setting_burst,
		sizeof(w1ov64b40reartxd_PDC_setting_burst)/sizeof(kal_uint16));
	#if W1OV64B40REARTXD_PDC_OTP_DUMP
	value5000 = read_cmos_sensor(0x5000);
	value5F80 = read_cmos_sensor(0x5F80);
	value5F81 = read_cmos_sensor(0x5F81);
	value5F82 = read_cmos_sensor(0x5F82);
        value624F = read_cmos_sensor(0x624F);
	LOG_INF( "w1ov64b40reartxd_write_sensor_PDC end  0x5000_value:0x%x value5F80:0x%x  value5F81:0x%x  value5F82:0x%x value624F::0x%x",
		value5000,value5F80,value5F81,value5F82,value624F);
	#endif
}
#endif

#ifdef W1OV64B40REARTXD_CROSSSTALK_ENABLE

static kal_uint16 w1ov64b40reartxd_crosstalk_setting[288*2];

static void w1ov64b40reartxd_read_sensor_crosstalk_Cali(void)
{
	kal_uint16 idx = 0, eeprom_crosstalk_addr = 0x102F, sensor_crosstalk_addr = 0x5A40;
        #if W1OV64B40REARTXD_CROSSSTALK_OTP_DUMP
        kal_uint16 idx2 = 0;
        #endif
	for (idx = 0; idx < 288; idx++) {
		eeprom_crosstalk_addr = 0x102F + idx;
		sensor_crosstalk_addr = 0x5A40 + idx;
		w1ov64b40reartxd_crosstalk_setting[2*idx] = sensor_crosstalk_addr;
		w1ov64b40reartxd_crosstalk_setting[2*idx + 1] = read_cmos_eeprom_8(eeprom_crosstalk_addr);
                #if W1OV64B40REARTXD_CROSSSTALK_OTP_DUMP
                idx2 = 2*idx + 1;
                LOG_INF( "dump: sensor_crosstalk_addr[%d]=0x%x, sensor_crosstalk_data[%d]=0x%x \n",
                    idx, sensor_crosstalk_addr,idx2, w1ov64b40reartxd_crosstalk_setting[2*idx + 1]);
                #endif
	}
}

static void w1ov64b40reartxd_write_sensor_crosstalk(void)
{
	#if W1OV64B40REARTXD_CROSSSTALK_OTP_DUMP
	kal_uint16  crosstalk_5000_value = 0;
	kal_uint16  crosstalk_5A02_value = 0;
	kal_uint16  crosstalk_5A40_value = 0;
	kal_uint16  crosstalk_5A41_value = 0;
	kal_uint16  crosstalk_5A42_value = 0;
	#endif
	//write_cmos_sensor(0x5000,0xCB); //enable sensor crosstalk
	//write_cmos_sensor(0x5380,0x0F); //enable sensor crosstalk
	ov64b2q_table_write_cmos_sensor(w1ov64b40reartxd_crosstalk_setting,
		sizeof(w1ov64b40reartxd_crosstalk_setting)/sizeof(kal_uint16));
	#if W1OV64B40REARTXD_CROSSSTALK_OTP_DUMP
	crosstalk_5000_value = read_cmos_sensor(0x5000);
	crosstalk_5A02_value = read_cmos_sensor(0x5A02);
	crosstalk_5A40_value = read_cmos_sensor(0x5A40);
	crosstalk_5A41_value = read_cmos_sensor(0x5A41);
	crosstalk_5A42_value = read_cmos_sensor(0x5A42);
	LOG_INF( "w1ov64b40reartxd_write_sensor_crosstalk end  cross5000:0x%x  crosstalk_5380_values:0x%x cross5A40:0x%x  cross5A41:0x%x  cross5A42:0x%x",
	crosstalk_5000_value, crosstalk_5A02_value, crosstalk_5A40_value,crosstalk_5A41_value,crosstalk_5A42_value);
	#endif
...
static struct stCAM_CAL_DATAINFO_STRUCT st_rear_w1ov64b40reartxd_eeprom_data ={
        .sensorID= W1OV64B40REARTXD_SENSOR_ID,
        .deviceID = 0x01,
        .dataLength = 0x1151,
        .sensorVendorid = 0x19000101,//bug604664 liudijn, add, 2021/04/03,  fixed hal can't get w1ov64b40reartxd sensor  otp data.
        .vendorByte = {1,2,3,4},
        .dataBuffer = NULL,
};

static struct stCAM_CAL_CHECKSUM_STRUCT st_rear_w1ov64b40reartxd_Checksum[11] =
{
    ...
    {PDAF_PROC3_ITEM,0x0D50,0x0D50,0x102C,0x102D,0x55},//gain map
    {W1OV64B40REARTXD_CT_ITEM,0x102E,0x102E,0x114E,0x114F,0x55},
    {TOTAL_ITEM,0x0000,0x0000,0x114F,0x1150,0x55},
    ...
    do {
        *sensor_id = return_sensor_id();
        if (*sensor_id == imgsensor_info.sensor_id) {
            ...
            //+bug604664 liudijn, add, 2021/03/29, w1ov64b40reartxd eeprom bring up.
            #if W1OV64B40REARTXD_OTP_ENABLE
            size = imgSensorReadEepromData(&st_rear_w1ov64b40reartxd_eeprom_data,st_rear_w1ov64b40reartxd_Checksum);
            if(size != st_rear_w1ov64b40reartxd_eeprom_data.dataLength || (st_rear_w1ov64b40reartxd_eeprom_data.sensorVendorid >> 24)!= w1ov64b40reartxd_read_eeprom(0x0001)) {
                pr_err("get eeprom data failed\n");
                if(st_rear_w1ov64b40reartxd_eeprom_data.dataBuffer != NULL) {
                    kfree(st_rear_w1ov64b40reartxd_eeprom_data.dataBuffer);
                    st_rear_w1ov64b40reartxd_eeprom_data.dataBuffer = NULL;
                }
                //*sensor_id = 0xFFFFFFFF;
                //return ERROR_SENSOR_CONNECT_FAIL;
            } else {
                pr_info("get eeprom data success size:%d\n", size);
                imgSensorSetEepromData(&st_rear_w1ov64b40reartxd_eeprom_data);
            }
            #endif
            //-bug604664 liudijn, add, 2021/03/29, w1ov64b40reartxd eeprom bring up.
            //read_EepromQSC();
            ...
            //+bug604664 liudijin, add, 2021/05/07,ov64b40 sensor enable sensor pdc and crosstalk function.
            #ifdef W1OV64B40REARTXD_PDC_ENABLE
            w1ov64b40reartxd_read_sensor_pdc_Cali();
            w1ov64b40reartxd_read_sensor_crosstalk_Cali();
            #endif
            //-bug604664 liudijin, add, 2021/05/07,ov64b40 sensor enable sensor pdc and crosstalk function.
...
static kal_uint32 open(void)
{
    ...
    //+bug604664 liudijin, add, 2021/05/07,ov64b40 sensor enable sensor pdc and crosstalk function.
    #ifdef W1OV64B40REARTXD_PDC_ENABLE
    w1ov64b40reartxd_write_sensor_PDC();
    LOG_INF("w1ov64b40reartxd_write_sensor_PDC \n");
    #endif
    //-bug604664 liudijin, add, 2021/05/07,ov64b40 sensor enable sensor pdc and crosstalk function.
                    ...
                    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    //+bug604664 liudijin, add, 2021/05/07,ov64b40 sensor enable sensor pdc and crosstalk function.
    #if W1OV64B40REARTXD_CROSSSTALK_ENABLE
    w1ov64b40reartxd_write_sensor_crosstalk();
    LOG_INF("w1ov64b40reartxd_write_sensor_crosstalk \n");
    #endif
    //-bug604664 liudijin, add, 2021/05/07,ov64b40 sensor enable sensor pdc and crosstalk function.
    ...
    kal_uint32 shutter_2ndframe, kal_uint32 gain_2ndframe)
{
    int _length = 0;
//    int k = 0;
    _ov64_is_seamless = true;
    memset(_ov64_i2c_data, 0x0, sizeof(_ov64_i2c_data));
    _ov64_size_to_write = 0;

    pr_err("seamless_switch %d, %d, %d, %d, %d sizeof(_i2c_data) %d\n",
        scenario_id, shutter, gain, shutter_2ndframe, gain_2ndframe, sizeof(_ov64_i2c_data));
    ...
    pr_debug("%s _ov64_is_seamless %d, _ov64_size_to_write %d\n",
            __func__, _ov64_is_seamless, _ov64_size_to_write);
#if 0
    for (k = 0; k <_ov64_size_to_write; k+=2) {
        pr_debug( "k = %d, 0x%x , 0x%x \n", k,  _ov64_i2c_data[k], _ov64_i2c_data[k+1]);
    }
#endif
    ...
    for (k = 0; k <_ov64_size_to_write; k+=2) {
        pr_debug( "k = %d, 0x%x , 0x%x \n", k,  _ov64_i2c_data[k], read_cmos_sensor(_ov64_i2c_data[k]));
    }
#endif
    _ov64_is_seamless = false;
    pr_err("exit\n");
    return ERROR_NONE;
}
            ...
            UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_SEAMLESS_SWITCH:
        ...
        //-bug604664,huangguoyong.wt, add, 2021/05/10 add vo64b40 seamless code
    ...
    *(feature_data + 1) = imgsensor_info.min_shutter;
    ...
    case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
        *(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = -150000; //ExtB P210608-03177 zhanghao2, modify, 2021/06/12,fix ITS sensor_fusion fail
        break;
