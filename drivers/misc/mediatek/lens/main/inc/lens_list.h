...
//+bug604664 chenbocheng.wt, add, 2020/12/17, 1st supply main af CN3938A porting
...
#define FP5516WE4AF_SetI2Cclient FP5516WE4AF_SetI2Cclient_Main
#define FP5516WE4AFIoctl FP5516WE4AF_Ioctl_Main
#define FP5516WE4AFRelease FP5516WE4AF_Release_Main
#define FP5516WE4AFGetFileName FP5516WE4AF_GetFileName_Main
extern int FP5516WE4AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
	spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long FP5516WE4AF_Ioctl(struct file *a_pstFile,
	unsigned int a_u4Command, unsigned long a_u4Param);
extern int FP5516WE4AF_Release(struct inode *a_pstInode,
	struct file *a_pstFile);
extern int FP5516WE4AF_GetFileName(unsigned char *pFileName);
//-bug604664 chenbocheng.wt, add, 2020/12/17, 1st supply main af CN3938A porting

//+bug604664 liudijin.wt, add, 2020/12/24, 3st supply main af CN3938AXL porting
#define CN3938AXLAF_SetI2Cclient CN3938AXLAF_SetI2Cclient_Main
#define CN3938AXLAF_Ioctl CN3938AXLAF_Ioctl_Main
#define CN3938AXLAF_Release CN3938AXLAF_Release_Main
#define CN3938AXLAF_GetFileName CN3938AXLAF_GetFileName_Main
extern int CN3938AXLAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
	spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long CN3938AXLAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
	unsigned long a_u4Param);
extern int CN3938AXLAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int CN3938AXLAF_GetFileName(unsigned char *pFileName);
//-bug604664 liudijin.wt, add, 2020/12/24, 3st supply main af CN3938AXL porting
