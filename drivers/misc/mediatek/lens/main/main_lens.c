...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	...
	{1, AFDRV_FP5516WE4AF, FP5516WE4AF_SetI2Cclient, FP5516WE4AF_Ioctl,
	 FP5516WE4AF_Release, FP5516WE4AF_GetFileName, NULL},
	//-bug604664 chenbocheng.wt, add, 2020/12/17, 1st supply main af CN3938A porting
	//+bug604664 liudijin.wt, add, 2020/12/24, 3st supply main af CN3938AXL porting
	{1, AFDRV_CN3938AXLAF, CN3938AXLAF_SetI2Cclient, CN3938AXLAF_Ioctl,
	CN3938AXLAF_Release, CN3938AXLAF_GetFileName, NULL},
	//-bug604664 liudijin.wt, add, 2020/12/24, 3st supply main af CN3938AXL porting
	//+bug604664 liudijin.wt, add, 2021/03/18, 1st supply ov64b40 main af GT9764AF porting
...
static int g_regVCAMAFEn;
 ...
 void AFRegulatorCtrl_Main(int Stage)
{
		...
		if (regVCAMAF == NULL) {
			...
			if (node) {
				...
				if (strncmp(CONFIG_ARCH_MTK_PROJECT,
					...
					regVCAMAF =
					regulator_get(lens_device, "vldo28");
					LOG_INF("%d,[Init] regulator_get %p\n", __LINE__,regVCAMAF);
					#endif
				}
...
//#if !defined(CONFIG_MTK_LEGACY)
	...
	#ifdef AF_Independent_Power
	AFRegulatorCtrl_Main(0);
	AFRegulatorCtrl_Main(1);
	mdelay(5);
	LOG_INF("AF_Open mdelay 5ms\n");
	#endif
	//-EXTB P210730-04853 yaoguizhen.wt, add, 2021/8/4, for fix IIC communication  fail when apply af init setting
#endif
	/* OIS/EIS Timer & Workqueue */
