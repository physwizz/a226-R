			   ...
			   size_t size, loff_t *offset)
{
	...
	if (kbuf == NULL)
		return -ENOMEM;
         ...
         //-bug604664 zhouyikuan, add, 2020/12/18,hi4821q_qt eeprom bring up
         } else if((g_eepromSubData != NULL)&&(W1HI846FRONTST_SENSOR_ID == pdata->sensor_info.sensor_id || W1HI846FRONTST2_SENSOR_ID == pdata->sensor_info.sensor_id || W1GC8034FRONTDC_SENSOR_ID == pdata->sensor_info.sensor_id || W1C8490FRONTTXD_SENSOR_ID == pdata->sensor_info.sensor_id)){
             u32 totalLength = (u32)*offset+ (u32)size;
