			       ...
			       int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		//OA252773 houqintao.wt -modify micbias0 1P9 to 2P5 20210103
		/* MISBIAS0 = 2P5V */
			       ...
			       int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		//OA252773 houqintao.wt -modify micbias1 2P6 to 2P7 20210103
		/* MISBIAS1 = 2P7V */
			       ...
			       int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		//OA252773 houqintao.wt -modify micbias2 1P9 to 2P5 20210103
		/* MISBIAS2 = 2P5V */
